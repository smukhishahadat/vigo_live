...
public class EditorMediaActivity extends Activity {
    ...
    private void init() {
        ...
        //最大时长5分钟
        mMutiMediaView.enableSelectView(60 * 1000);
        ...
        mMutiMediaView.setOnSelectMediaChangeListener(new MutiMediaView.OnSelectMediaChangeListener() {
            ...
            public void onClick(MediaInfo info, int position) {
                ...
                AlivcCropInputParam cropInputParam = new AlivcCropInputParam.Builder().setRatioMode(mInputParam.getRatio())
                ...
                if (info.mimeType.startsWith("video")) {
                    ...
                    AliyunVideoCropActivity.startVideoCropForResult(EditorMediaActivity.this,
                            cropInputParam, AliyunVideoCropActivity.REQUEST_CODE_EDITOR_VIDEO_CROP );
