...
/**
 * 资源管理和资源下载Activity继承此Activity
 * todo 在资源管理和下载界面优化的时候移除
 */
public abstract class AbstractActionBarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mViewContainer = (LinearLayout) LayoutInflater.from(this).inflate(R.layout.alivc_editor_activity_action_bar, null);
    }
    ...
    private void setupActionBar() {
        ...
        if (mCustomView != null) {
            ...
            View view = LayoutInflater.from(this).inflate(R.layout.alivc_editor_include_action_bar_profile, null);
            ...
            mIvRight.setImageResource(R.mipmap.aliyun_crop_svideo_icon_next);
