...
public class ControlView extends RelativeLayout implements View.OnTouchListener {
    ...
    private LinearLayout mAlivcFlip;
    private LinearLayout mAlivcSpeed;
    private LinearLayout mAlivcTimer;
    private LinearLayout mAlivcFlash;
    ...
    private void assignViews() {
        ...
        ivSpeed = findViewById(R.id.alivc_record_iv_speed);
        mAlivcMusic = findViewById(R.id.alivc_music);
        mAlivcFlip = findViewById(R.id.alivc_flip);
        mAlivcSpeed = findViewById(R.id.alivc_speed);
        mAlivcTimer = findViewById(R.id.alivc_record_timer);
        mAlivcFlash = findViewById(R.id.alivc_record_flash);
        ...
        UIConfigManager.setImageResourceConfig(
            ...
            , new int[] {R.mipmap.ic_timer, R.mipmap.gallery, R.mipmap.alivc_svideo_icon_gif_effect}
        );
    ...
    private Drawable getSwitchCameraDrawable() {
        ...
        Drawable drawable = UIConfigManager.getDrawableResources(getContext(), R.attr.switchCameraImage, R.mipmap.ic_flip);
    ...
    private void setViewListener() {
        ...
        ivSpeed.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {

                if (mListener != null) {
                    mListener.onClickDute();
                }
                /*if (aliyunRateBar.getVisibility() == VISIBLE){
        ...
        llUpload.setOnClickListener(new OnClickListener() {
    ...
    private void updateTittleView() {
        if (recordState == RecordState.STOP) {
            mAlivcFlip.setVisibility(VISIBLE);
            mAlivcSpeed.setVisibility(VISIBLE);
            mAlivcTimer.setVisibility(VISIBLE);
            mAlivcFlash.setVisibility(VISIBLE);
            ...
            mAlivcFlip.setVisibility(GONE);
            mAlivcSpeed.setVisibility(GONE);
            mAlivcTimer.setVisibility(GONE);
            mAlivcFlash.setVisibility(GONE);
    ...
    public void updateCutDownView(boolean isClickable) {
        ...
        //UIConfigManager.setImageResourceConfig(ivReadyRecord, R.attr.countdownImage, R.mipmap.ic_timer);
    }
    ...
    private void updateMusicSelView() {
        ...
        if (hasRecordPiece) {
            ...
            mAlivcSpeed.setClickable(false);
    ...
    private void updateBottomView() {
        if (isEffectSelViewShow) {
            ...
            if (recordState == RecordState.STOP) {
                ...
                llGifEffect.setVisibility(INVISIBLE);
                llBeautyFace.setVisibility(INVISIBLE);
                llUpload.setVisibility(INVISIBLE);
                aliyunComplete.setVisibility(INVISIBLE);
            }
        }
