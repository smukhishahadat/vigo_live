...
public class SegmentedProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(new RectF(0, 0, percentCompleted, getHeight()),
                cornerRadius,
                cornerRadius,
                progressPaint);
    ...
    private void updateProgress(long millisPassed) {
        ...
        Log.i(TAG, "updateProgress: " + percentCompleted);
        invalidate();
    }
    ...
    public void enableAutoProgressView(long timeInMillis) {
        ...
        countDownTimerWithPause = new CountDownTimerWithPause(maxTimeInMillis, FPS_IN_MILLI, false) {
            ...
            public void onTick(long millisUntilFinished) {
                timePassed = SegmentedProgressBar.this.maxTimeInMillis - millisUntilFinished;
    ...
    public int getProgressPercent() {
        return (int) ((progressBarWidth / percentCompleted) * 100);
    }
