...
import com.bakbakum.shortvdo.databinding.DailogLoaderBinding;
import com.bakbakum.shortvdo.databinding.DailogTermConditionBinding;
import com.bakbakum.shortvdo.databinding.DialogPercentageBinding;
import com.bakbakum.shortvdo.databinding.LoutPopupBinding;
import com.bakbakum.shortvdo.databinding.LoutSendBubbleBinding;
import com.bakbakum.shortvdo.databinding.LoutSendResultPopupBinding;
...
public class CustomDialogBuilder {
    ...
    public TextView showLoadingDialogWithPercentage() {
        mBuilder.setCancelable(false);
        mBuilder.setCanceledOnTouchOutside(false);
        DialogPercentageBinding binding = DataBindingUtil.inflate(LayoutInflater.from(mContext), R.layout.dialog_percentage, null, false);
        mBuilder.setContentView(binding.getRoot());
        mBuilder.show();
