...
public class VerificationViewModel extends ViewModel {
    ...
    public void requestVerify() {
        ...
        if (proofUri != null && !proofUri.isEmpty()) {
            ...
            body1 = MultipartBody.Part.createFormData("photo_id_image", file.getName(), requestFile2);
        }
        ...
        if (useUri != null && !useUri.isEmpty()) {
            ...
            RequestBody requestFile2 =
                    RequestBody.create(file,MediaType.parse("multipart/form-data"));
            body2 = MultipartBody.Part.createFormData("photo_with_id_image", file.getName(), requestFile2);
        }
